...
export function NewLeadForm() {
  ...
  return (
    <section id="new-lead-form" className="py-12 md:py-16 bg-gradient-to-b from-transparent via-background/80 to-background">
        <div className="max-w-md mx-auto px-6">
            <Card className="bg-card/95 backdrop-blur-sm border border-border/50 shadow-2xl shadow-primary/10 transition-all duration-300 hover:scale-105 hover:shadow-primary/20">
                ...
                <CardContent className="p-6">
                    <div className='text-center mb-6'>
                        <CardTitle className="text-card-foreground font-antonio text-2xl">{t.leadFormTitle}</CardTitle>
                        <CardDescription className="font-body">{t.leadFormDescription}</CardDescription>
                    </div>
                    <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        render={({ field }) => (
                            <FormItem>
                            <FormLabel className="font-antonio">{t.formLabelName}</FormLabel>
                            <FormControl>
                        ...
                        render={({ field }) => (
                            <FormItem>
                            <FormLabel className="font-antonio">{t.formLabelEmail}</FormLabel>
                            <FormControl>
                        ...
                        render={({ field }) => (
                            <FormItem>
                            <FormLabel className="font-antonio">{t.formLabelPhone}</FormLabel>
                            <FormControl>
